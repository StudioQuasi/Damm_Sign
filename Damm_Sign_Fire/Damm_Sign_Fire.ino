...
#define NUMBER_OF_FLAMES 46 // depends on number of neopixel triplets. 5 for 16 NeoPixel ring. 4 for 12 NeoPixel ring
#define FLAME_WIDTH 2      // How wide are the flames (in LEDs)
